...
from keras import Dense, Activation, Embedding, Flatten, MaxPooling1D, Dropout, Conv1D, Input, LSTM, SpatialDropout1D, Bidirectional

train_features = pd.read_csv('train_features.csv', delimiter=',') 
test_feautres = pd.read_csv('test_features.csv', delimiter=',') 
